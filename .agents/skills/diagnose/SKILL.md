...
When the bug is frontend-visible, use
`.agents/skills/e2e-debug-and-qa/SKILL.md` for the browser repro loop before
deep backend diagnosis. Start with observed browser facts, screenshots,
console output, and network failures, then drill into backend code or API curls.
