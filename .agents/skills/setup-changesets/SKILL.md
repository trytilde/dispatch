...
description: "Set up changesets in a new or existing repository. Use when asked to add changesets, set up releases, or configure versioning. Handles single packages and monorepos. Optionally sets up a shared reusable workflow in an organization or user .github repo."
---
