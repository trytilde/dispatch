...
3. Treat `openbot.config.ts`, `agents/`, `configuration/skills/`, `sandbox/`, and `providers/` as fork-owned. Resolve conflicts by preserving their intent while adopting updated interfaces.
