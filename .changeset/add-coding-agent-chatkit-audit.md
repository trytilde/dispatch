---
"@trytilde/sdk": minor
"@trytilde/sdk-codex": minor
"@trytilde/sdk-claude-code": minor
"@trytilde/sdk-cursor": minor
...
Add Codex, Claude Code, and Cursor hook adapters that record searchable ChatKit messages and canonical tool executions while `tilde plugin` installs Tilde MCP servers and skills.
