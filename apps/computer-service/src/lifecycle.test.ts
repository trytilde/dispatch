...
import { LifecyclePhase } from "@trytilde/dispatch-computer-service-proto";
...
describe("lifecycleBundleDigest", () => {
  it("is stable across input order and changes with file content", () => {
    const file = (path: string, content: string) => ({
      $typeName: "dispatch.computer.v1.LifecycleFile" as const,
      path,
    ...
    const script = {
      $typeName: "dispatch.computer.v1.LifecycleScript" as const,
      id: "start",
      path: "start.sh",
