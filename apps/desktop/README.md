...
The Electron desktop shell for the Dispatch web UI and local control service. Privileged Node.js behavior remains in Electron main/preload code behind a narrow bridge; the renderer stays browser-compatible.
