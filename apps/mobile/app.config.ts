...
const config: ExpoConfig = {
  ...
  owner,
  // The launcher mark is an agent avatar drawn from the same artwork the app renders for
  // its agents, generated by scripts/generate-mobile-icons.mjs. iOS takes the opaque
  // square; Android takes a transparent foreground over adaptiveIcon.backgroundColor.
