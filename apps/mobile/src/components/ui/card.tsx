...
export const Card = memo(function Card({ children, style, ...props }: CardProps) {
...
export const CardHeader = memo(function CardHeader({ children, style, ...props }: CardHeaderProps) {
  return (
...
export const CardTitle = memo(function CardTitle({ children, style, ...props }: CardTitleProps) {
  return (
    <Text
      variant="title"
      style={[
...
export const CardFooter = memo(function CardFooter({ children, style, ...props }: CardFooterProps) {
  return (
    <View
      style={[
        {
