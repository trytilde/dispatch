...
const commands = [
  ...
  ["auth", "Authenticate with Tilde and select a team"],
  ["state", "Import or export Tilde team state"],
  ...
  ["connect HOST", "Tunnel a remote dev host's Electron desktop"],
  ["remote HOST TASK", "Run desktop development or packaging on a remote host"],
...
const menuItems = [
  ...
  { command: "auth", description: "Authenticate with Tilde" },
  { command: "state", description: "Import or export Tilde state" },
  { command: "tunnel", description: "Run a command behind a Tilde tunnel" },
  { command: "plugin", description: "Configure a coding-agent plugin" },
  { command: "sdk", description: "Develop and verify the Tilde SDK" },
