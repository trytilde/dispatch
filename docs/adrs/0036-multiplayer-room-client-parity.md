...
Dispatch retains the shared client-runtime room contract for durable roster,
...
Tilde owns membership, admission, authorization, and event audiences. Dispatch
...
<FOLLOW UP>
Owner: Dispatch web and mobile clients
