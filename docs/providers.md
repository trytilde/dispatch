...
| `skills-provider` | Sync authored skills and reconcile an exact external skill registry per agent. |
| `tools-provider` | Reconcile a dynamic MCP server, Tilde control-plane toolkit, and deployment-platform tools per agent. |
