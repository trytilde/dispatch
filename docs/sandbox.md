...
The authored folder is called `sandbox/` only for compatibility with Eve's project layout. OpenBot runtime terminology uses Computer, including computer-service, computer-service-provider, environment variables, and tool filenames.
