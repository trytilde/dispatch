...
Validation covers workflow YAML parsing and formatting, all CLI tests, the CLI build, and argument forwarding into the read-only release status command. PR CI remains the final Linux-hosted repository proof.
