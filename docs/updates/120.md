...
- `openbot`: scaffold Memory Catcher, its managed synthesis skills, required
  discoverable source files, deterministic dependency-first deployment even
  during a one-agent reconciliation, and automatic recall in future Factory
  templates.
...
- Validation at initial publication: 78 core SDK tests, 92 Vercel adapter tests,
  14 Agent Provider tests, 19 Agent Service Provider tests, 173 CLI tests, and
