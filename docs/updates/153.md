...
- Follow-up review blocks durable agent credential registration at the proxy before forwarding; the expanded core SDK suite passes 125 tests, including preserved MCP session/protocol headers.
