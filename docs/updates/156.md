...
PR: https://github.com/trytilde/dispatch/pull/156
...
- All ten SDK-family packages were published successfully with npm browser approval. Independently fetched registry manifests match every local packed SHA-512 integrity. HeyAsh snapshot replacement is a separate follow-up; this version change does not deploy applications or reset databases.
