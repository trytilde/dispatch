...
- Fixed an invalid work-overview selector exposed by Next.js development CSS parsing
  when consuming the installed package.
- Companion API PR: https://github.com/trytilde/api/pull/280 (merged).
