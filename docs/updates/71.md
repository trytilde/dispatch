...
Allow a Dispatch installation to use an authenticated Codex subscription as its inference source while retaining Vercel AI Gateway support.
...
- `@trytilde/dispatch-inference-provider`: Codex provider and Vercel template handoff.
- `@trytilde/cli`: initialization, development, and deployment integration.
