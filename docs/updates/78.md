...
- `@trytilde/dispatch-computer-service-provider`: desktop session template records active readiness and cleans it up on exit.
- `@trytilde/dispatch-computer-service`: validates display readiness, waits before CUA dispatch, and separates desktop health from service health.
- `@trytilde/dispatch-computer-tools`: reports readiness consistently to authored agents.
- `@trytilde/dispatch-agent-provider`: updates the generated Computer-use skill instructions to respect readiness results.
