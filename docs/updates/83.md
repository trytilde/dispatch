...
- `@trytilde/dispatch-ui` anchors the preview to the chat pane rather than a shell-side grid column and moves the composer clear of it.
...
- `@trytilde/dispatch-web`: selects the floating workspace mode for browser and Electron contexts.
- `@trytilde/dispatch-ui`: positions the 240-320px preview 16px from the chat pane's bottom-right; moves the composer and queued-message controls clear of it; preserves compact takeover behavior.
