...
6. Ensure exe.dev SSH host trust/auth is configured. Target needs Node 24, pnpm 10, Linux, sudo,
   systemd user services, and passwordless package installation. Provider bootstrap installs
   Chromium, Cua, Xvnc, noVNC, and desktop packages.
