...
agents, reconciles their Vercel AI SDK endpoint URL and enabled state, and turns
on local-runtime tunneling during development. It does not expose vendor CRUD
