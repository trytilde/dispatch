...
/**
 * A recurring or event-driven instruction with one or more OR'd triggers.
 */
export type Routine = {
    /**
     * Default ChatKit agent used by schedules and manual runs. Event actions may override it.
     */
    agent_inbox_id?: string | null;
    authorization: ResourceAuthorizationModes;
    created_at: WrappedChronoDateTime;
    ...
    org_id: string;
    /**
     * Shared instruction. Event triggers choose explicitly whether to inject it.
     */
    prompt?: string | null;
    team_id: string;
    title: string;
...
/**
 * How an event-triggered run supplies the routine instruction to ChatKit.
 */
...
/**
 * A routine execution initiated by one schedule, event delivery, or manual run.
 */
...
/**
 * One independently firing trigger belonging to a Routine.
 */
export type RoutineTrigger = RoutineTriggerConfiguration & {
    created_at: WrappedChronoDateTime;
    enabled: boolean;
    id: WrappedUuidV4;
    last_error?: string | null;
    ...
    /**
     * Human-readable rendering for schedule triggers.
     */
...
/**
 * Trigger-specific configuration retained behind one Routine lifecycle root.
 */
export type RoutineTriggerConfiguration = {
    kind: 'schedule';
    /**
...
/**
 * User-authored trigger fields used by create and replace-all update requests.
 */
export type RoutineTriggerInput = RoutineTriggerConfiguration & {
    enabled?: boolean;
    id?: null | WrappedUuidV4;
    metadata?: null | WrappedJsonValue;
};
...
/**
 * User-authored fields for replacing mutable Routine state.
 */
export type UpdateRoutineRequestInner = {
    ...
    title?: string | null;
    /**
     * Replace all triggers atomically when supplied.
     */
    triggers?: Array<RoutineTriggerInput> | null;
};
...
export type DeleteRoutineResponse2 = DeleteRoutineResponses[keyof DeleteRoutineResponses];
...
export type SetRoutineOwnershipData = {
    body: SetResourceAccessModeRequest;
    path: {
        /**
         * Team ID
...
export type SetRoutineOwnershipResponses = {
    200: ResourceAuthorization;
};

export type SetRoutineOwnershipResponse = SetRoutineOwnershipResponses[keyof SetRoutineOwnershipResponses];
...
export type RunRoutineResponses = {
    /**
     * Completed manual Routine execution
     */
    200: RoutineExecution;
};

export type RunRoutineResponse = RunRoutineResponses[keyof RunRoutineResponses];

export type ListRoutineRunsData = {
    body?: never;
    path: {
        /**
         * Team ID
...
export type ListRoutineRunsResponses = {
    /**
...
export type ListRoutineRunsResponse = ListRoutineRunsResponses[keyof ListRoutineRunsResponses];

export type SetRoutineVisibilityData = {
    body: SetResourceAccessModeRequest;
    path: {
        /**
         * Team ID
...
export type SetRoutineVisibilityResponses = {
    200: ResourceAuthorization;
};

export type SetRoutineVisibilityResponse = SetRoutineVisibilityResponses[keyof SetRoutineVisibilityResponses];

export type ListRoutineGrantsData = {
    body?: never;
    path: {
        /**
         * Team ID
...
export type ListRoutineGrantsResponses = {
    200: Array<ResourceGrant>;
};

export type ListRoutineGrantsResponse = ListRoutineGrantsResponses[keyof ListRoutineGrantsResponses];

export type AddRoutineGrantData = {
    body: CreateResourcePlaneGrantRequest;
    path: {
        /**
         * Team ID
...
export type AddRoutineGrantResponses = {
    200: ResourceGrant;
};

export type AddRoutineGrantResponse = AddRoutineGrantResponses[keyof AddRoutineGrantResponses];

export type RemoveRoutineGrantData = {
    body?: never;
    path: {
        /**
         * Team ID
    ...
    query?: never;
    url: '/api/v1/team/{team_id}/routines/{routine_id}/{plane}/grants/{principal_type}/{principal_id}';
};

export type RemoveRoutineGrantResponses = {
    200: unknown;
};
