...
Generated ConnectRPC and protobuf types for the API-key-protected service inside a Dispatch Computer. This is an internal provider transport, not an API for the web or desktop UI.

## Public API

The root and `gen/*` subpath re-export generated `dispatch.computer.v1` symbols:
