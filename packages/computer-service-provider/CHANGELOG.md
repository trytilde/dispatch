...
- [#47](https://github.com/trytilde/dispatch/pull/47) [`2eee1d1`](https://github.com/trytilde/dispatch/commit/2eee1d17e18aee13974456382a9a0556ca9c929c) Thanks [@danielblignaut](https://github.com/danielblignaut)! - Rename the Computer lifecycle package to clarify that it builds, deploys, and provisions the Computer service, and remove the `computer-tools` compatibility re-export so agent runtime tools remain independently owned.
...
- [#62](https://github.com/trytilde/dispatch/pull/62) [`19a4a0e`](https://github.com/trytilde/dispatch/commit/19a4a0e52b41f5afbdaddaed1029992ed2b4d961) Thanks [@danielblignaut](https://github.com/danielblignaut)! - Seed tracked repository symlinks into the trusted development sandbox instead of failing, so a repository that links `.claude/skills` at `.agents/skills` or `CLAUDE.md` at `AGENTS.md` can still start development. Symlink targets must stay relative and resolve inside the repository.
