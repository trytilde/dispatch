...
- `TildePlatform` implements `Platform` for the Tilde credential, organization, team, and optional API-origin shared by Tilde agent, skills, and tools providers. `tildePlatform` is the default shared instance.
