...
describe("repository manifest generation", () => {
  it("generates stable agent and provider imports", () => {
    const source = generatedSource([
      "configuration/agents/openbot.ts",
      "configuration/providers/custom/index.ts",
      "configuration/skills/tilde/SKILL.md",
    ]);
    expect(source).toContain(
      'import * as agent0 from "../../../../configuration/agents/openbot.js";',
    );
    expect(source).toContain(
      'import provider0 from "../../../../configuration/providers/custom/index.js";',
    );
